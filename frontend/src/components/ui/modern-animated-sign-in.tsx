...
// Image component helper for compatibility
      ...
      {googleLogin && (
        <>
          ...
          >
            ...
            >
              <span className='flex items-center justify-center w-full h-full gap-3 text-neutral-800 dark:text-neutral-200 text-sm'>
                <Image
                ...
                <section className='relative'>
                  ...
                  {field.type === 'password' && (
                    <button
                      ...
                      className='absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5 text-neutral-500 hover:text-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-200'
                    >
                      {visible ? (
